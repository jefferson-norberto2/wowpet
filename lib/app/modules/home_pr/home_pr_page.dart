...
import 'package:wowpet/app/modules/home_pr/register_pr_imunization_screen.dart';
...
class HomePrPageState extends State<HomePrPage> {
  ...
  void initState() {
    super.initState();
    store = Modular.get<HomePrStore>();
  }

  @override
  void dispose() {
    Modular.dispose<HomePrStore>();
    super.dispose();
  }
    ...
    return Container(
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          body: ScopedBuilder<HomePrStore, Exception, int>(
            store: store,

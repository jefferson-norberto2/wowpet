...
class ResgisterPrImunizationScreen extends StatefulWidget {
  const ResgisterPrImunizationScreen({super.key});

  @override
  State<ResgisterPrImunizationScreen> createState() =>
      _ResgisterPrImunizationScreenState();
}

class _ResgisterPrImunizationScreenState
    extends State<ResgisterPrImunizationScreen> {
  @override
